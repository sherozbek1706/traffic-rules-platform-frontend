...
//             ? rawToken
//             : `Bearer ${rawToken}`;
//           const r = await fetch(`/api/v1/students/${student.id}/stats`, {
...
//       <aside
//         className={[
//           "absolute right-0 top-0 h-full w-full max-w-2xl bg-white shadow-xl ring-1 ring-slate-200",
...
//                       ) : (
//                         perTest.map((t) => (
//                           <tr key={t.test_id} className="hover:bg-slate-50/40">
